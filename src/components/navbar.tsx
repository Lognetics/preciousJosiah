      ...
      <nav className="container-x flex h-16 items-center gap-4 md:h-20">
        ...
        <div className="ml-auto flex shrink-0 items-center gap-2 xl:ml-0">
          <button
            ...
            className="grid h-10 w-10 place-items-center rounded-full border border-[var(--line)] text-[var(--muted)] transition-colors hover:border-royal hover:text-royal"
          >
          ...
          <button
            ...
            aria-label="Menu"
            aria-expanded={open}
            className="grid h-10 w-10 place-items-center rounded-full border border-[var(--line)] xl:hidden"
          >
